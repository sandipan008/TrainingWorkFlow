...
public class EmailSenderService {
	...
	public String mailSendingForTask(String username, String Email, String Task, String assessmentLink) throws MessagingException {
		...
		LOGGER.info("Message sent successfully for task to :- "+Email);
		
		
		}catch(Exception e) {
			LOGGER.info("Exception encountered while sending task mail..");
		}
	...
	public String mailSendingForNextTask(String username, String Email, String nextTask, LocalDate duedate) throws MessagingException {
		...
		LOGGER.info("Next task mail has sent successfully..");
		
		
		}catch(Exception e) {
			LOGGER.info("Exception encountered while sending next task mail..");
		}
	...
	public String mailSendingForTaskCompletion(String username, String Email) throws MessagingException {
		...
		LOGGER.info("Task completion mail has sent successfully..");
		
		
		}catch(Exception e) {
			LOGGER.info("Exception encountered while sending task completion mail..");
		}
	...
	public String mailSendingFailureTask(String username, String Email, String task) {
		...
		LOGGER.info("Message sent for failure task to :- "+Email);
		
		
		}catch(Exception e) {
			LOGGER.info("Exception encountered while sending task failure mail..");
		}
	...
	public String mailSendingForPoc(String name, String Email, String Task,String branch,String githuburl) throws MessagingException {
		...
		LOGGER.info("Message sent successfully for POC to :- "+Email);
		
		
		}catch(Exception e) {
			LOGGER.info("Exception encountered while sending POC mail..");
		}
	...
	public String mailSendingFailurePoc(String username, String Email, String task) {
		...
		LOGGER.info("Message sent for failure POC to :- "+Email);
		
		
		}catch(Exception e) {
			LOGGER.info("Exception encountered while sending failed POC mail..");
		}
	...
	public String mailSendingToApprover(String team, String Email[], String task, String url, String username) {
		...
		LOGGER.info("Message sent successfully to approver:- "+team);
		
		
		}catch(Exception e) {
			LOGGER.info("Exception encountered while sending mail to Approver..");
		}
	...
	public String mailSendingForPocApprover(String team, String Email[], String task, String url, String username,String branch,String githuburl) {
		...
		LOGGER.info("Message sent successfully to POC approver:- "+team);
		
		
		}catch(Exception e) {
			LOGGER.info("Exception encountered while sending mail for POC Approver..");
		}
		return "Message sent successfully to approver:- "+team;
	}
}
